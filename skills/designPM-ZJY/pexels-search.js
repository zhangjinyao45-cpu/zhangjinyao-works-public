...
/**
 * Minimal Pexels search helper for designPM-ZJY phase 4.
 *
 * Usage:
 ...
 *   node pexels-search.js "editorial restaurant interior" --write results.json
 */
...
Usage:
  node pexels-search.js "<query>" [options]
...
Examples:
  node pexels-search.js "moody coffee shop interior"
  node pexels-search.js "night city bar warm light" --per-page 6 --orientation portrait
  node pexels-search.js "cozy cafe window light" --write cafe-images.json
`.trim());
}
